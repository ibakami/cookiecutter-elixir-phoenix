...
const PAGE_NAME = "Reducer/Context Demo"
...
const LazyComponent = React.lazy(() =>
  import(
    /* webpackChunkName: "ReducerContextDemo" */ "./reducer-context-demo-container"
  ).then(module => ({
    default: module.ReducerContextDemoContainer,
  })),
)

export const ReducerContextDemoRoot: React.FC<RouteComponentProps> = (
  props,
): JSX.Element => {
