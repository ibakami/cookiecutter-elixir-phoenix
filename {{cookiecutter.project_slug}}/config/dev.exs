...
config :{{cookiecutter.phoenix_app_slug}}_web, {{cookiecutter.phoenix_app_module}}Web.Endpoint,
  ...
  watchers: [
    node: [
      ...
      "development",
      "--watch-stdin",
      cd: Path.expand("../apps/{{cookiecutter.phoenix_app_slug}}_web/assets", __DIR__)
    ]
  ]
...
config :{{cookiecutter.phoenix_app_slug}}_web, {{cookiecutter.phoenix_app_module}}Web.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/{{cookiecutter.phoenix_app_slug}}_web/{live,views}/.*(ex)$",
      ~r"lib/{{cookiecutter.phoenix_app_slug}}_web/templates/.*(eex)$"
    ]
  ]
